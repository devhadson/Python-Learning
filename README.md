...
Python-Learning/
│
├── 01.1.Basic-Examples-Print/
│   ├── 01.01.hola-mundo.py
│   ├── 01.02.imprimir-variable.py
│   ├── 01.03.concatenacion-print.py
│   ├── 01.04.print-f-strings.py
│   ├── 01.05.multiples-prints.py
│   ├── 01.06.print-separador-es.py
│   ├── 01.07.print-final-end.py
│   ├── 01.08.print-comillas-texto.py
│   ├── 01.09.print-numero-texto.py
│   └── 01.10.print-lista-elementos.py
│
├── 01.2.Basic-Examples-Input/
│   ├── 01.11.input-simple.py
│   ├── 01.12.input-numerico.py
│   ├── 01.13.input-sin-mensaje.py
│   ├── 01.14.input-calculo.py
│   └── 01.15.multiples-inputs.py
│
├── 01.3.Basic-interaction-exercises/
│   ├── 01.16.calcular-edad.py
│   ├── 01.17.conversor-unidades.py
│   ├── 01.18.calculadora-simple.py
│   ├── 01.19.saludo-personalizado.py
│   └── 01.20.contador-letras.py
│
├── 01.4.Basic-math-exercises/
│   ├── 01.21.calcular-edad.py
│   ├── 01.22.conversor-unidades.py
│   ├── 01.23.calculadora-simple.py
│   ├── 01.24.saludo-personalizado.py
│   └── 01.25.contador-letras.py
│
├── 01.5.Exercises-with-strings/
│   ├── 01.26.repetidor-palabras.py
│   ├── 01.27.convertidor-mayusculas.py
│   ├── 01.28.separador-nombres.py
│   ├── 01.29.contador-palabras.py
│   └── 01.30.inversor-texto.py
```
---
